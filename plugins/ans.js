...
.catch(error => {
  ...
  ezra({ nomCom: "bing4", reaction: "🌀", categorie: "creins-IA" }, async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      let caption = '*bing images by creins xmd Tech*';
  ...
  ezra({ nomCom: "ai2", reaction: "🌀", categorie: "creins xmd-IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
...
ezra({ nomCom: "gpt-all", reaction: "🌀", categorie: "creins xmd-IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
