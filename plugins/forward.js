...
ezra({ nomCom: "forward", categorie: 'Creins-Group', reaction: "📤" }, async (dest, zk, commandeOptions) => {
  ...
  if ( verifAdmin | superUser ) {
    ...
    repondre('*CREINS Xforce Forwarded Your Message To All group members in their DMs.*');
  } else {
