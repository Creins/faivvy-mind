...
module.exports = { session: process.env.SESSION_ID || 'creins',
    PREFIXE: process.env.PREFIX || "+",
    GITHUB : process.env.GITHUB|| 'https://github.com/mr-X-force/CREINS-MD-XFORCE',
    OWNER_NAME : process.env.OWNER_NAME || "CREINS",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254787243487",
    DEV : process.env.DEV || "Creinsibraal Ke",
    ...
    AUTO_REPLY : process.env.GREET_MESSAGE || "yes", 
    AUTO_STICKER : process.env.AUTO_STICKER || "no", 
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By CREINS-MD-XFORCE',   
    ...
    WEBSITE :process.env.GURL || "https://creins-ai-site.vercel.app",
    CAPTION : process.env.CAPTION || "CREINS-MD-XFORCE",
    BOT : process.env.BOT_NAME || 'CREINS-MD-XFORCE',
